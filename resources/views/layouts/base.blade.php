                                        ...
                                        @if(Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Sale Setting" href="{{route('admin.sale')}}">Sale Settiong</a>
                                                    </li>
                                                    <li class="menu-item">
...
{{$slot}}
    ...
    <script src="https://cdn.tiny.cloud/1/u6gjuw0o8rwoj8xv6bx9pst19csewujgq65vuaidmih0qatp/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
