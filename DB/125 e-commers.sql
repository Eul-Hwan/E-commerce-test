...
-- 테이블 데이터 ec.orders:~4 rows (대략적) 내보내기
DELETE FROM `orders`;
...
-- 테이블 데이터 ec.order_items:~9 rows (대략적) 내보내기
...
INSERT INTO `order_items` (`id`, `product_id`, `order_id`, `price`, `quantity`, `created_at`, `updated_at`) VALUES
	...
	(6, 8, 3, 39.00, 1, '2021-10-09 00:01:38', '2021-10-09 00:01:38'),
	(7, 12, 3, 182.00, 1, '2021-10-09 00:01:38', '2021-10-09 00:01:38'),
	(8, 8, 4, 39.00, 1, '2021-10-09 00:06:04', '2021-10-09 00:06:04'),
	(9, 12, 4, 182.00, 1, '2021-10-09 00:06:04', '2021-10-09 00:06:04');
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('1oXHNgXL7wc9w0eZNhQGmo36Xlq6U8HsVOAlzxlY', 2, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36', '', 1633738312);
...
-- 테이블 데이터 ec.transactions:~1 rows (대략적) 내보내기
