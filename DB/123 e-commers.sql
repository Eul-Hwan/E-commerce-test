...
-- 테이블 데이터 ec.orders:~0 rows (대략적) 내보내기
DELETE FROM `orders`;
...
INSERT INTO `orders` (`id`, `user_id`, `subtotal`, `discount`, `tax`, `total`, `firstname`, `lastname`, `mobile`, `email`, `line1`, `line2`, `city`, `province`, `country`, `zipcode`, `status`, `is_shipping_different`, `created_at`, `updated_at`) VALUES
	(1, 2, 454.00, 0.00, 95.34, 549.34, 'IU', 'IU', '01053788798', 'IU@IU.com', 'test line1', 'test line2', 'Seoul', 'sung-nam', 'Korea', '123456', 'ordered', 1, '2021-10-06 04:16:08', '2021-10-06 04:16:08'),
	(2, 2, 691.00, 0.00, 145.11, 836.11, 'IU', 'IU', '01053788798', 'IU@IU.com', 'Nit-3', NULL, 'sung', 'bun', 'Korea', '121001', 'ordered', 0, '2021-10-07 00:29:16', '2021-10-07 00:29:16');
...
-- 테이블 데이터 ec.order_items:~4 rows (대략적) 내보내기
DELETE FROM `order_items`;
/*!40000 ALTER TABLE `order_items` DISABLE KEYS */;
INSERT INTO `order_items` (`id`, `product_id`, `order_id`, `price`, `quantity`, `created_at`, `updated_at`) VALUES
	(1, 9, 1, 415.00, 1, '2021-10-06 04:16:08', '2021-10-06 04:16:08'),
	(2, 8, 1, 39.00, 1, '2021-10-06 04:16:08', '2021-10-06 04:16:08'),
	(3, 9, 2, 415.00, 1, '2021-10-07 00:29:16', '2021-10-07 00:29:16'),
	(4, 7, 2, 94.00, 1, '2021-10-07 00:29:16', '2021-10-07 00:29:16'),
	(5, 12, 2, 182.00, 1, '2021-10-07 00:29:16', '2021-10-07 00:29:16');
...
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('41FaiEwlKrA5c5otj4AV4SyGmALYmS2bYihzID8z', 4, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36', '', 1633675794);
...
-- 테이블 데이터 ec.transactions:~0 rows (대략적) 내보내기
...
-- 테이블 데이터 ec.users:~3 rows (대략적) 내보내기
DELETE FROM `users`;
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `two_factor_secret`, `two_factor_recovery_codes`, `remember_token`, `current_team_id`, `profile_photo_path`, `utype`, `created_at`, `updated_at`) VALUES
	...
	(2, 'User', 'user@user.com', NULL, '$2y$10$GrZ8h867VJc1v3bsMH5bMuqrEhjMLnI1a/KTQDbpvAh8IF7via8wC', NULL, NULL, NULL, NULL, NULL, 'USR', '2021-09-17 10:33:46', '2021-09-17 10:33:46'),
