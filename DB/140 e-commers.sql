...
-- 테이블 데이터 ec.categories:~6 rows (대략적) 내보내기
...
-- 테이블 데이터 ec.coupons:~3 rows (대략적) 내보내기
DELETE FROM `coupons`;
...
-- 테이블 데이터 ec.home_categories:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 ec.home_sliders:~2 rows (대략적) 내보내기
...
-- 테이블 데이터 ec.migrations:~22 rows (대략적) 내보내기
...
-- 테이블 데이터 ec.orders:~6 rows (대략적) 내보내기
DELETE FROM `orders`;
...
-- 테이블 데이터 ec.products:~24 rows (대략적) 내보내기
DELETE FROM `products`;
/*!40000 ALTER TABLE `products` DISABLE KEYS */;
INSERT INTO `products` (`id`, `name`, `slug`, `short_description`, `description`, `regular_price`, `sale_price`, `SKU`, `stock_status`, `featured`, `quantity`, `image`, `images`, `category_id`, `created_at`, `updated_at`) VALUES
	(1, 'totam nisi consequatur sed', 'totam-nisi-consequatur-sed', 'Sed repellendus maiores doloribus excepturi qui cupiditate. Quos voluptate enim qui eum. Et ut cupiditate consequatur et. Odio in ex similique doloribus inventore.', 'Illo repellendus nam ipsum provident ipsam. Et dolores qui et doloribus repellat est consequatur non. Aut dolores sed voluptatem porro nulla veritatis. Iusto accusantium impedit mollitia omnis minima qui ut facere. Reprehenderit eaque alias quo nam dolore ratione autem. Doloremque eligendi iure qui quidem nesciunt. Sit dolore et eos voluptates. Nesciunt tempora doloremque ea odio architecto ut quia. Ipsum fugiat dolores non rem quas molestiae.', 54.00, 50.00, 'DIGI495', 'instock', 0, 140, 'digital_3.jpg', NULL, 2, '2021-09-18 12:11:58', '2021-09-26 23:57:11'),
...
-- 테이블 데이터 ec.reviews:~3 rows (대략적) 내보내기
DELETE FROM `reviews`;
...
-- 테이블 데이터 ec.sales:~1 rows (대략적) 내보내기
DELETE FROM `sales`;
...
-- 테이블 데이터 ec.sessions:~10 rows (대략적) 내보내기
DELETE FROM `sessions`;
/*!40000 ALTER TABLE `sessions` DISABLE KEYS */;
INSERT INTO `sessions` (`id`, `user_id`, `ip_address`, `user_agent`, `payload`, `last_activity`) VALUES
	('F0QnIHbfNLCDVooHbW2rRLohduARzUPcZnZnqAfD', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36', '', 1634106379),
	('k5w9cevZEEVyk84HZ6uovp4nFDiWFotZGhMiQ8Dw', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiQ1A0aTcydFdGbThBMWJiVkpjWVdFaEt6TjVIR05mTGpwN0J0TXJMMCI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1634082940),
	('oi7wI9df60AcycSOMiuPfsz3eI0JH1iZB9sPsnhJ', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoidldXdlViWlpqemtYSDNjeVFsUkdYYVdkaG1NeEZpR2ozbXV2cXIxSiI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1634076615),
	('PS1YTX0axkbNnC9RutKezlvwpb4ugFJjFAi0Z9gq', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoicEtLTUJhT3E4VDBHV1VaaVFTb0xwTFMyNDU2dWVBZjRLbmpRekNrZSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fX0=', 1634083903),
	('QHQZRlbYYnERSXbLKY5Sc7RTv2hM39DyeFw3OzGB', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36', '', 1634076657),
	('tbqvZ49WgcMayyl8Bh0tQJtrHR3KCIRrIwQZ5eG3', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36', '', 1634083963),
	('Ty4OVWjxtVQhkaVVsCBrmcEoMBkIm9qG4jvsVxh1', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiQktkWW11NmUyRDgyV0NmTTlaRGp2RkdpMWh2aHViZzI5YjRjMVJoQiI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1634076616),
	('uTeuZc6cgn8DllsQtg3cacvI1SdiAdOjlgIT54gO', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36', 'YToyOntzOjY6Il90b2tlbiI7czo0MDoiT0d5VXlpb0ozYUR2UGcxZVByNDBuTGJ5WFhpb1V1aUZxRkNwYzhMayI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319fQ==', 1634083886),
	('v8xuMPcO9jp825Sy5uIGCXwCGtHNOsskJ0lKUBq9', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiRVYwaVI3U0JEU2doM2t5a2VPQlM2ZEhyQVlJeXhoRHkzOHVkUTBZZSI7czo2OiJfZmxhc2giO2E6Mjp7czozOiJvbGQiO2E6MDp7fXM6MzoibmV3IjthOjA6e319czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6MjE6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMCI7fX0=', 1634082902),
	('wKzPkUEJOCS5vidPCch5pLYz2Kzn2FwadgAEa19h', NULL, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.71 Safari/537.36', 'YTozOntzOjY6Il90b2tlbiI7czo0MDoiS2U2cUEzcG9tM1BuRDVEV21wSHdJTUp6WWRVWE4xd1NNSVpNbzhVOCI7czo5OiJfcHJldmlvdXMiO2E6MTp7czozOiJ1cmwiO3M6Mjc6Imh0dHA6Ly8xMjcuMC4wLjE6ODAwMC9sb2dpbiI7fXM6NjoiX2ZsYXNoIjthOjI6e3M6Mzoib2xkIjthOjA6e31zOjM6Im5ldyI7YTowOnt9fX0=', 1634082912);
...
-- 테이블 데이터 ec.settings:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 ec.shippings:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 ec.users:~5 rows (대략적) 내보내기
DELETE FROM `users`;
